...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/adsplusteam/adsplus-ios-cn"
  ...
  spec.source       = { :git => "https://github.com/adsplusteam/adsplus-ios-cn.git", :tag => "#{spec.version}" }
  ...
  # spec.xcconfig = { "HEADER_SEARCH_PATHS" => "$(SDKROOT)/usr/include/libxml2" }
   ...
   spec.dependency "GDTMobSDK", "~> 4.14.42"
